...
Usage:
  join-weekly-fips.R -o <path> --jhu <path> --vaxboost <path> --rr <path> --hosp <path> [--covidestim <logical>] [--weekly <logical>] --metadataJHU <path> --rejectsJHU <path> [--cdc <path>] [--nyt <path>] [--rejectsNYT <path>] [--imputeNE <path>] [--statemap <path>] [--writeRejects <path>] [--writeMetadata <path>]
  join-weekly-fips.R (-h | --help)
  join-weekly-fips.R --version
...
args <- docopt(doc, version = 'join-weekly-fips.R 0.1')
